...
@section('main-content')
           <div class="breadcrumb">
                <h1>Dashboard</h1>
                <ul>
                    <li><a href="">Distributor Utama</a></li>
            ...
            <div class="col-lg-12 col-md-12 d-flex flex-wrap flex-row padding_lr_0">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card height_card_dashboard_2 card-icon-bg card-icon-bg-primary o-hidden mb-3">
                        <div class="card-body align-items-center text-center justify-content-between">
                        <div class="logo_card_2">
                            <img src="{{asset('assets/images/icon_bintang/distributor_utama.png')}}" alt="">
                        </div>
                            <div class="content max_width_bintang m-0 align-items-end">
                                <p class="text-muted mt-2 mb-0">Pendapatan Distributor Utama</p>
                                <p class="text-primary text-24 line-height-1 mb-2">Rp.210.000.000</p>
                            </div>
                        </div>
                    </div>
