    ...
    <div class="row mb-4">
        <div class="col-lg-12 col-md-12 col-sm-12 d-flex justify-content-center mb-3">
            <div class="input-group">
                <a href="{{ route('servicemeta_create') }}">
        ...
        <div class="col-md-12 mb-3">
            <div class="card text-left">
                <div class="card-body">
                    <div class="row">
                        <h4 class="col-sm-12 card-title mb-3">List Service Meta</h4>
                    </div>
                                ...
                                @foreach($groups as $group)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" onclick="deleteConfirm({{ $group->meta_id }}); return false;" class="btn btn-delete ripple btn-sm m-1">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
