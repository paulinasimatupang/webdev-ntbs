                            ...
                            <table id="deafult_ordering_table" class="display table table-striped table-bordered" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Component Content Type</th>
                                            <th scope="col">Component Label</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" onclick="deleteConfirm({{ $item->comp_id }}); return false;" class="btn btn-danger ripple btn-sm m-1">Delete</a>
                                            </td>
                                        </tr>
                                        @php
                                            $no++;
...
<script>
    function deleteConfirm(id) {
        ...
        if (r == true) {
            var url = '{{route("component_destroy",[":id"])}}';
