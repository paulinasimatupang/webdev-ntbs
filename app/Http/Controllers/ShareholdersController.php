...
use App\Http\Requests\ShareholderCreateRequest;
...
class ShareholdersController extends Controller
{
    ...
    /**
     * @var ShareholderValidator
     */
    protected $validator;

    /**
     * ShareholdersController constructor.
     *
     * @param ShareholderRepository $repository
     * @param ShareholderValidator $validator
     */
    public function __construct(ShareholderRepository $repository, ShareholderValidator $validator)
    {
     ...
     *
     * @param  ShareholderCreateRequest $request
     *
     * @return \Illuminate\Http\Response
     *
     * @throws \Prettus\Validator\Exceptions\ValidatorException
     */
    public function store(ShareholderCreateRequest $request)
    {
        DB::beginTransaction();
        try {
     ...
     * @throws \Prettus\Validator\Exceptions\ValidatorException
     */
    public function update(ShareholderUpdateRequest $request, $id)
    {
        DB::beginTransaction();
        try {
